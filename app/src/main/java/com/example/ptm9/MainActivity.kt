...
import com.example.ptm9.Network.ApiClient
import com.example.ptm9.Response.ApiResponse
import com.example.ptm9.Response.Mahasiswa
import com.example.ptm9.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun Insert(view: View) {
        val intent = Intent(this, com.example.ptm9.Fitur.Insert::class.java)
